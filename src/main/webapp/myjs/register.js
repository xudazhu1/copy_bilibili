...
//	user_agent_type() ? mobile_move() : desktop_move();
	...
	$("#email").blur(function(){
		...
		data1[$(this).attr("name")] = $(this)[0].value;
		$.get("c_account/check", data1 , function(data) {
			if ( data === "可以使用") {
				email = true;
			} else {
				email = false;
